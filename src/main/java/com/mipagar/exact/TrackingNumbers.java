 ...
 *       &lt;sequence>
 *         &lt;element ref="{}TrackingNumber" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "TrackingNumbers")
public class TrackingNumbers {

    @XmlElement(name = "TrackingNumber", required = true)
    protected List<TrackingNumber> trackingNumber;
     ...
     * 
     */
    public List<TrackingNumber> getTrackingNumber() {
        if (trackingNumber == null) {
            trackingNumber = new ArrayList<TrackingNumber>();
        }
