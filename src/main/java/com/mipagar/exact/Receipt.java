 ...
 *       &lt;sequence>
 *         &lt;element ref="{}ReceiptLine" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class Receipt {
    ...
    @XmlElement(name = "ReceiptLine", required = true)
    protected List<ReceiptLine> receiptLine;
    ...
    public List<ReceiptLine> getReceiptLine() {
        if (receiptLine == null) {
            receiptLine = new ArrayList<ReceiptLine>();
        }
